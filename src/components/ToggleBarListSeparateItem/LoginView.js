...
export default function LoginView() {
  return (
    <div className=" h-[30rem] w-[56rem] grid rounded-[2rem] shadow-2xl absolute left-80 top-[7.5rem]  text-center  grid-cols-2">
      <div className="flex float-left  bg-[#C8DBFF] rounded-tl-3xl rounded-bl-3xl roun">
        <svg
          ...
          viewBox="0 0 9 18"
          fill="none"
          className=" bg-transparent mt-[12px] ml-7 cursor-pointer"  
        >
          <path
        ...
        <button className="h-[23px] w-[55px] mt-[9px] ml-2 font-semibold ">
          Home
        </button>
      </div>
